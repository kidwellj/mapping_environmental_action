...
# Adapt colour above to use oranges - scale_fill_brewer(palette = "Oranges") + 
...
# TODO: Clipping here to buildings shapefile
...
# Adapt colour above to use oranges - scale_fill_brewer(palette = "BrBG") + 
ggplot() + 
  geom_polygon(aes(x = long, y = lat, group = group, 
                   fill = UR8FOLD), 
...
urbanrural_table %>%
  ...
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
    kableExtra::scroll_box(width = "100%", height = "800px", caption = 'Group Counts by Urban Rural Scale')
